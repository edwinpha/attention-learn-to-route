...
import os
import pickle
from problems.op.state_op_3d import StateOP3D
from utils.beam_search import beam_search


class OP3D(object):

    NAME = 'op_3d'  # Orienteering problem
    ...
    def make_dataset(*args, **kwargs):
        return OP3DDataset(*args, **kwargs)

    @staticmethod
    def make_state(*args, **kwargs):
        return StateOP3D.initialize(*args, **kwargs)
